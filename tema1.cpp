...
int main(int argc, char * argv[]){
 ...
 //variabile in care pun informatii precum greutatea maxima/min, nr maxim de elemente, etc pe care le gasesc in fisier precedate de OPEN_WINDOW

	int pers_id, p_weight;
//variabile in care retin informatiile pe care le gasesc in fisierul de input precedate de ADD_PERSON

	int id, g, nr_pers; //informatii folosite la procesarea mai multor persoane
